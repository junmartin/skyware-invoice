                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        @auth
                            ...
                            <li class="nav-item"><a class="nav-link" href="{{ route('invoices.active-next') }}">Active Next Cycle</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('invoices.index') }}">Invoices</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('stamping.index') }}">Stamping Queue</a></li>
